...
@date: 07/24/26
@purpose: This program collects sale data from the user, and writes the data to a text file
*/
...
int main(){
    ...
    dataFile.open("week9_lab1.txt", ios :: out);
    ...
    // create a heading for (week9_lab1.txt)
